...
module design_1
  ...
  reset_gen_imp_1MBKAOM reset_gen
       (.axi_clk(axi_clk),
        ...
        .clk_300m(clk_300m),
        .clk_300m_peripheral_reset(reset_gen_peripheral_reset),
...
module reset_gen_imp_1MBKAOM
   (axi_clk,
    ...
    clk_300m,
    clk_300m_peripheral_reset,
    dcm_locked,
    ext_reset_in_0,
    hb_clk_peripheral_aresetn,
    hb_phy_clk,
    hb_phy_rx_clk,
    hb_phy_rx_clk_peripheral_reset,
    mb_debug_sys_rst,
    mb_reset);
  input axi_clk;
  ...
  input clk_300m;
  output [0:0]clk_300m_peripheral_reset;
  input dcm_locked;
  input ext_reset_in_0;
  output [0:0]hb_clk_peripheral_aresetn;
  input hb_phy_clk;
  input hb_phy_rx_clk;
  output [0:0]hb_phy_rx_clk_peripheral_reset;
  ...
  wire clk_300m;
  wire [0:0]clk_300m_peripheral_reset;
  wire dcm_locked;
  wire ext_reset_in_0;
  wire [0:0]hb_clk_peripheral_aresetn;
  wire hb_phy_clk;
  wire hb_phy_rx_clk;
  wire [0:0]hb_phy_rx_clk_peripheral_reset;
  ...
  design_1_proc_sys_reset_3_0 hb_phy_rx_clk_reset_gen
       (.aux_reset_in(1'b1),
        ...
        .ext_reset_in(axi_clk_peripheral_aresetn),
        .mb_debug_sys_rst(1'b0),
        .peripheral_reset(hb_phy_rx_clk_peripheral_reset),
        .slowest_sync_clk(hb_phy_rx_clk));
endmodule
