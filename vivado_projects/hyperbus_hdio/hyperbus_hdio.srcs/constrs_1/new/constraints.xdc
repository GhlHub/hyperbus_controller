...
# Primary 100 MHz reference clock (differential input, Bank 46)
# Pin locations: sysclk_p = F23 (IO_L14P_T2L_N2_GC_46_F23)
#               sysclk_n = E23 (IO_L14N_T2L_N3_GC_46_E23)
...
create_generated_clock -name hb_ck_fwd \
  -source [get_pins {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/u_oddr_ck/CLK}] \
  -divide_by 1 \
...
set_max_delay -datapath_only 0.800 -from [get_ports {io_hb_dq_0[0]}] -to [get_pins {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/g_dq_phy[0].u_iddr_dq/D}]
set_max_delay -datapath_only 0.800 -from [get_ports {io_hb_dq_0[1]}] -to [get_pins {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/g_dq_phy[1].u_iddr_dq/D}]
set_max_delay -datapath_only 0.800 -from [get_ports {io_hb_dq_0[2]}] -to [get_pins {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/g_dq_phy[2].u_iddr_dq/D}]
set_max_delay -datapath_only 0.800 -from [get_ports {io_hb_dq_0[3]}] -to [get_pins {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/g_dq_phy[3].u_iddr_dq/D}]
set_max_delay -datapath_only 0.800 -from [get_ports {io_hb_dq_0[4]}] -to [get_pins {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/g_dq_phy[4].u_iddr_dq/D}]
set_max_delay -datapath_only 0.800 -from [get_ports {io_hb_dq_0[5]}] -to [get_pins {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/g_dq_phy[5].u_iddr_dq/D}]
set_max_delay -datapath_only 0.800 -from [get_ports {io_hb_dq_0[6]}] -to [get_pins {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/g_dq_phy[6].u_iddr_dq/D}]
set_max_delay -datapath_only 0.800 -from [get_ports {io_hb_dq_0[7]}] -to [get_pins {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/g_dq_phy[7].u_iddr_dq/D}]

set_max_delay -datapath_only 1.700 -from [get_cells {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/g_dq_phy[0].u_oddr_dq}] -to [get_ports {io_hb_dq_0[0]}]
set_max_delay -datapath_only 1.700 -from [get_cells {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/g_dq_phy[1].u_oddr_dq}] -to [get_ports {io_hb_dq_0[1]}]
set_max_delay -datapath_only 1.700 -from [get_cells {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/g_dq_phy[2].u_oddr_dq}] -to [get_ports {io_hb_dq_0[2]}]
set_max_delay -datapath_only 1.700 -from [get_cells {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/g_dq_phy[3].u_oddr_dq}] -to [get_ports {io_hb_dq_0[3]}]
set_max_delay -datapath_only 1.700 -from [get_cells {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/g_dq_phy[4].u_oddr_dq}] -to [get_ports {io_hb_dq_0[4]}]
set_max_delay -datapath_only 1.700 -from [get_cells {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/g_dq_phy[5].u_oddr_dq}] -to [get_ports {io_hb_dq_0[5]}]
set_max_delay -datapath_only 1.700 -from [get_cells {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/g_dq_phy[6].u_oddr_dq}] -to [get_ports {io_hb_dq_0[6]}]
set_max_delay -datapath_only 1.700 -from [get_cells {u_design_1_wrapper/design_1_i/hyperbus_controller_0/inst/u_hyperbus_phy/g_phy_ultrascale_plus.u_phy_impl/g_dq_phy[7].u_oddr_dq}] -to [get_ports {io_hb_dq_0[7]}]
