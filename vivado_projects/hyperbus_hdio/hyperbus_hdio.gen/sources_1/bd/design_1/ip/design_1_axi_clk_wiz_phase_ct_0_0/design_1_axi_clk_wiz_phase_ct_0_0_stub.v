...
//               /raid/work/ghl_ip/hyperbus_ai3/vivado_projects/hyperbus_hdio/hyperbus_hdio.gen/sources_1/bd/design_1/ip/design_1_axi_clk_wiz_phase_ct_0_0/design_1_axi_clk_wiz_phase_ct_0_0_stub.v
...
module design_1_axi_clk_wiz_phase_ct_0_0(s_axi_aclk, s_axi_aresetn, s_axi_awaddr, 
  s_axi_awvalid, s_axi_awready, s_axi_wdata, s_axi_wstrb, s_axi_wvalid, s_axi_wready, 
  s_axi_bresp, s_axi_bvalid, s_axi_bready, s_axi_araddr, s_axi_arvalid, s_axi_arready, 
  s_axi_rdata, s_axi_rresp, s_axi_rvalid, s_axi_rready, clk_wiz_locked, psdone, psclk, psen, 
  psincdec, phase_target_sel, phase_target_onehot, irq)
/* synthesis syn_black_box black_box_pad_pin="s_axi_aresetn,s_axi_awaddr[5:0],s_axi_awvalid,s_axi_awready,s_axi_wdata[31:0],s_axi_wstrb[3:0],s_axi_wvalid,s_axi_wready,s_axi_bresp[1:0],s_axi_bvalid,s_axi_bready,s_axi_araddr[5:0],s_axi_arvalid,s_axi_arready,s_axi_rdata[31:0],s_axi_rresp[1:0],s_axi_rvalid,s_axi_rready,clk_wiz_locked,psdone,psen,psincdec,phase_target_sel[2:0],phase_target_onehot[6:0],irq" */
...
/* synthesis syn_force_seq_prim="psclk" */;
  ...
  input psdone;
  output psclk /* synthesis syn_isclock = 1 */;
  output psen;
  output psincdec;
