...
vivado_bin_dir="/tools/Xilinx/${SIM_VER_XSIM}/Vivado/bin"
if [[ ! -d "$vivado_bin_dir" ]]; then
  echo "ERROR: Vivado ${SIM_VER_XSIM} not found at $vivado_bin_dir" >&2
  exit 1
fi
export PATH="$vivado_bin_dir:$PATH"
...
# script info
echo -e "hyperbus_controller_tb.sh - Script migrated for Vivado v2026.1 (64-bit)\n"
...
verilog xil_defaultlib -i "/tools/Xilinx/${SIM_VER_XSIM}/data/rsb/busdef" \
"$repo_root/infinion/002-26518_0B/s27kl0642.v" \

sv xil_defaultlib -i "/tools/Xilinx/${SIM_VER_XSIM}/data/rsb/busdef" -i "$repo_root/tb" \
