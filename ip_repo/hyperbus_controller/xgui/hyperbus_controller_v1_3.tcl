...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "PHY_IO_STYLE" -parent ${Page_0}
...
proc update_PARAM_VALUE.PHY_IO_STYLE { PARAM_VALUE.PHY_IO_STYLE } {
	# Procedure called to update PHY_IO_STYLE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PHY_IO_STYLE { PARAM_VALUE.PHY_IO_STYLE } {
	# Procedure called to validate PHY_IO_STYLE
	return true
}
...
proc update_MODELPARAM_VALUE.PHY_IO_STYLE { MODELPARAM_VALUE.PHY_IO_STYLE PARAM_VALUE.PHY_IO_STYLE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PHY_IO_STYLE}] ${MODELPARAM_VALUE.PHY_IO_STYLE}
}
