...
//    V1.0     VINI			     17 Mar 20    Initial release
...
//                 128Mb high-speed CMOS 3.0 and 1.8 Volt Core, x8 data bus
//
//
//////////////////////////////////////////////////////////////////////////////
//  Comments :
...
`define S70KS1282GABHI
//`define S70KS1282DPBHI
//`define S70KL1282GABHI
//`define S70KL1282DPBHI

`ifdef S70KS1282GABHI
	`define FREQ_200MHz_1P8V
	`define INDUSTRIAL
`elsif S70KS1282DPBHI
	`define FREQ_166MHz_1P8V
	`define INDUSTRIAL	
`elsif S70KL1282GABHI
	`define FREQ_200MHz_3P3V 
	`define INDUSTRIAL
`elsif S70KL1282DPBHI
...
module s70kl1282
	...
	hram_64mb  
		#(
			...
			32'h400000,			//id reg base address
			32'h400800,			//config reg base address
			1'b1,				//variable/fixed latency. fixed to "FIXED LATENCY" for 128Mb HyperRam. VARIABLE LATENCY available only for 64Mb. ,
			"S70KL1282GAXXXXXX",//Timing Model
			"S70KL1282" 		//Part ID
		)
		top(
			.DQ7(DQ7)      ,
...
module hram_64mb 
	...
	parameter TimingModel = "S70KS1282GAXXXXXX", //initialized to 64Mb hyperRam MPN, as this module denisity is 64Mb
    parameter PartID   = "S70KL1282"			
	)
    (
    DQ7      ,
    DQ6      ,
...
///////////////////////////////////////////////////////////////////////////////
	...
	reg [15:0] Identification_reg0 = {die_id,14'h0C81};
    ...
    begin
                ...
                begin
                    ...
                    begin
						...
						if(refresh_pulse)begin
							...
							REFCOLL_ACTIV = variable_latency;
							RWDSout_zd_tmp = 1'b0;
						end
					end
                end
        ...
        begin
            ...
            if (falling_edge_RESETNeg) begin
				...
				Identification_reg0 = {die_id,14'h0C81};//default value
 ...
 always @(falling_edge_CKDiff)
    ...
    BUFFERs_hram64Mb    BUF_DOut    (BuffOutDQ, BuffInDQ);
    BUFFERs_hram64Mb    BUF_RWDS    (BuffOutRWDS, BuffInRWDS);
    BUFFERs_hram64Mb    BUF_RWDSR   (BuffOutRWDSR, BuffInRWDSR);
...
module BUFFERs_hram64Mb (OUT,IN);
    input IN;
    output OUT;
    buf   ( OUT, IN);
endmodule
