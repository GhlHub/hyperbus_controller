...
set bd_tcl [file join $repo_root "build" "design_1_retargeted.tcl"]
...
foreach dir_to_delete [list \
    [file join $proj_dir "hyperbus_test_proj.srcs" "sources_1" "bd" "design_1"] \
    [file join $proj_dir "hyperbus_test_proj.gen" "sources_1" "bd" "design_1"] \
] {
